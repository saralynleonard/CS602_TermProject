...
module.exports = async (req, res, next) => {
    ...
    let mission7 = new Mission({
        ...
        aboutMission: "The PlatinumPioneer mission aims to explore and mine platinum-group metals from the asteroid 243 Ida, a known platinum-rich asteroid", 
